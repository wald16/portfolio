...
export const projects: Project[] = [
        ...
        description: 'A web app that simulates different types of color blindness in real time — built to raise awareness and improve accessibility.',    
        descriptionEs: 'Aplicación web que simula distintos tipos de daltonismo en tiempo real — creada para concientizar y mejorar la accesibilidad.',
        image: '/projects/daltonismo.png',
        tags: ['HTML', 'CSS', 'JavaScript', 'Docker', 'Nginx'],
        link: 'https://daltonismo.wald16.fun',
